...
const ChatMessage = ({ message, userId, isFirstMessage = false }) => {
  return (
    <div className={`${message.id === userId ? "bg-teal-dark" : "bg-dark bg-opacity-50"} py-2 ps-2 pe-3 text-break rounded`}>
